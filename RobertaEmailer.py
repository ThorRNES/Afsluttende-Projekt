...
SMTP_PORT: int = 587
SMTP_USER: Optional[str] = "RPAtest@outlook.dk"  # Kan laves med "None", hvis nødvendigt
SMTP_PASS: Optional[str] = "9HcuZFjJ4V7xeHN"  # Kode til SMTP-afsender
SMTP_STARTTLS: bool = True

MAIL_FROM: str = "RPAtest@outlook.dk"
